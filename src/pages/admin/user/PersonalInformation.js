...
import { faInfoCircle, faPhoneAlt, faUserShield } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <UserEditLayout>
            <div className="alert alert-primary d-flex align-items-center" role="alert">
                ...
                <div>
                    Esta información se le mostrará a los usuarios que posean caulquiera de los roles. 
                </div>
            </div>
